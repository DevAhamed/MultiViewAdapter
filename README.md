...
[![Code coverage](https://codecov.io/gh/DevAhamed/MultiViewAdapter/branch/3.x/graph/badge.svg)](https://codecov.io/gh/DevAhamed/MultiViewAdapter)
...
> :warning: MultiViewAdapter v3.0 uses AndroidX. If you would like to use this library with legacy support library, kindly switch to 2.x branch. 2.x is identical to 3.x branch.
...
[![Core](https://api.bintray.com/packages/devahamed/MVA3/adapter/images/download.svg)](https://bintray.com/devahamed/MVA3/adapter/_latestVersion)
...
[![Extensions](https://img.shields.io/badge/dynamic/json.svg?label=Extensions&query=name&url=https%3A%2F%2Fapi.bintray.com%2Fpackages%2Fdevahamed%2FMVA3%2Fext-databinding%2Fversions%2F_latest)](https://bintray.com/devahamed/MVA3/adapter/_latestVersion)
...
```gradle
dependencies {
    implementation 'dev.ahamed.mva3:adapter:3.0.0-SNAPSHOT' // Library
}
```
...
All the commits from v2.0.0-alpha02 is cloned in this release.
...
v3.0.0-alpha01 is identical to v2.0.0-alpha01 except, it uses AndroidX libraries.

|Type|Stability|Date|
|---|---|---|
|Major|Alpha|20-April-2019|

* Initial release for v3.x refactor with AndroidX support
