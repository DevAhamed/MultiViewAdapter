...
public class FlowerBinderWithPayload
    extends ItemBinder<Flower, FlowerBinderWithPayload.ViewHolder> {

  public FlowerBinderWithPayload(ItemDecorator itemDecorator) {
    super(itemDecorator);
  }
  ...
  @Override public void bind(ViewHolder holder, Flower item, List payloads) {
    Toast.makeText(holder.textView.getContext(), ((String) payloads.get(0)), Toast.LENGTH_SHORT)
        .show();
    bind(holder, item);
  }
